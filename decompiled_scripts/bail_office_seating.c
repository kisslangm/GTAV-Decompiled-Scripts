...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x286F (10351)
{
	var unk;
	float num;
	var unk4;
...
Vector3 func_104() // Position - 0x2902 (10498)
{
	return 0.37f, -0.5f, 2f;
}

Vector3 func_105() // Position - 0x2915 (10517)
{
	return -0.37f, -0.5f, 0f;
}

void func_106(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2928 (10536)
{
	if (func_5())
	{
		switch (iParam0)
...
void func_107() // Position - 0x2C08 (11272)
{
	return;
}

int func_108(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C10 (11280)
{
	int i;
...
BOOL func_109(BOOL bParam0) // Position - 0x2D26 (11558)
{
	bParam0;
