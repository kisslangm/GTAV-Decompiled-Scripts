...
int func_84() // Position - 0x7898 (30872)
{
...
void func_142(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x9E31 (40497)
{
...
int func_161(int iParam0) // Position - 0xA5A0 (42400)
{
