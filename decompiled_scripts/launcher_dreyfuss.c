...
BOOL func_2(Any* panParam0) // Position - 0x271 (625)
{
	...
	if (!func_180())
	{
		while (!func_171(*panParam0))
		{
			...
			if (!func_211(panParam0, *panParam0 != 2))
			{
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65AC (26028)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65F3 (26099)
{
...
BOOL func_73(int iParam0) // Position - 0x664E (26190)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x665E (26206)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66BE (26302)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A75 (27253)
{
	return Global_33105;
}

BOOL func_77(int iParam0) // Position - 0x6A80 (27264)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A90 (27280)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B32 (27442)
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72AC (29356)
{
...
int func_81() // Position - 0x75A7 (30119)
{
	return Global_2652571.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x75B6 (30134)
{
...
int func_83() // Position - 0x75E0 (30176)
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x75F8 (30200)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x760D (30221)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7624 (30244)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x767C (30332)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7726 (30502)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77BB (30651)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x77FF (30719)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7983 (31107)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7991 (31121)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x845C (33884)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x84DE (34014)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8536 (34102)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x853F (34111)
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x87FB (34811)
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x880B (34827)
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8828 (34856)
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8838 (34872)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B7B (35707)
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8B8C (35724)
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BD2 (35794)
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C58 (35928)
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C8B (35979)
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CDC (36060)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D7E (36222)
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DA0 (36256)
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DB7 (36279)
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8DC4 (36292)
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DFE (36350)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E39 (36409)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E75 (36469)
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E8E (36494)
{
	int num;
	var textLabel;
...
BOOL func_115() // Position - 0x8EF1 (36593)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_116() // Position - 0x8F07 (36615)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F1D (36637)
{
...
BOOL func_118(BOOL bParam0) // Position - 0x8F5F (36703)
{
...
struct<2> func_119(int iParam0) // Position - 0x8F87 (36743)
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93D4 (37844)
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6AC (42668)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9F2 (43506)
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAA97 (43671)
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB32 (43826)
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_126() // Position - 0xAB58 (43864)
{
	Global_79819 != 6;
...
void func_127(Ped pedParam0) // Position - 0xAB90 (43920)
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABE9 (44009)
{
...
int func_129(Ped pedParam0) // Position - 0xAC6C (44140)
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC9D (44189)
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACB2 (44210)
{
	int num;
...
int func_132() // Position - 0xAD34 (44340)
{
	int i;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD65 (44389)
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD80 (44416)
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xADCC (44492)
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE15 (44565)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE35 (44597)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE56 (44630)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xAEA9 (44713)
{
...
BOOL func_140(int iParam0) // Position - 0xAF26 (44838)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF79 (44921)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB06F (45167)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0DA (45274)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB119 (45337)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB268 (45672)
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB282 (45698)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2DB (45787)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB31C (45852)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB33E (45886)
{
...
BOOL func_150() // Position - 0xB37D (45949)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB38B (45963)
{
	int num;
...
BOOL func_152() // Position - 0xB3BE (46014)
{
...
void func_153(int iParam0) // Position - 0xB3E5 (46053)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB408 (46088)
{
...
void func_155() // Position - 0xB445 (46149)
{
	Global_21308 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB455 (46165)
{
...
BOOL func_157() // Position - 0xB4AC (46252)
{
...
void func_158() // Position - 0xB4CE (46286)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB4E3 (46307)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB53B (46395)
{
...
void func_161(Vehicle veParam0) // Position - 0xB592 (46482)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB5BE (46526)
{
...
void func_163() // Position - 0xB70F (46863)
{
...
void func_164(int iParam0) // Position - 0xB760 (46944)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB793 (46995)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB81D (47133)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB891 (47249)
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB89F (47263)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB8F6 (47350)
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB905 (47365)
{
...
BOOL func_171(int iParam0) // Position - 0xB946 (47430)
{
	int num;
...
void func_172(int iParam0) // Position - 0xB98B (47499)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9BD (47549)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBAF4 (47860)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB43 (47939)
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB54 (47956)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD35 (48437)
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD57 (48471)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBD68 (48488)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xBDB1 (48561)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
int func_181() // Position - 0xBDD5 (48597)
{
	if (func_184(2))
	{
...
BOOL func_182(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xBE76 (48758)
{
...
float func_183(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xBEA9 (48809)
{
...
BOOL func_184(int iParam0) // Position - 0xBEE3 (48867)
{
	eCharacter character;
...
BOOL func_185() // Position - 0xC603 (50691)
{
	return Global_101752.f_1;
}

BOOL func_186() // Position - 0xC611 (50705)
{
	if (Global_98610 != -1)
...
BOOL func_187() // Position - 0xC634 (50740)
{
...
BOOL func_188() // Position - 0xC64E (50766)
{
	if (Global_79825)
		return true;
...
BOOL func_189() // Position - 0xC678 (50808)
{
	return Global_101765.f_400 > 0;
}

BOOL func_190(int iParam0, int iParam1) // Position - 0xC689 (50825)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xC6C1 (50881)
{
	return Global_1575086;
}

BOOL func_192() // Position - 0xC6CD (50893)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_193(var uParam0, int iParam1) // Position - 0xC6E9 (50921)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_194() // Position - 0xCECC (52940)
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_195(var uParam0) // Position - 0xCEE7 (52967)
{
	float num;
...
void func_196(int iParam0, var uParam1) // Position - 0xCF75 (53109)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_197(BOOL bParam0) // Position - 0xCFD9 (53209)
{
...
BOOL func_198(Vehicle veParam0) // Position - 0xD070 (53360)
{
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD09A (53402)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_183(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD122 (53538)
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD15D (53597)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1B3 (53683)
{
...
void func_203(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD24E (53838)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD33F (54079)
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD37B (54139)
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD3B4 (54196)
{
	BOOL flag;
	int i;
...
BOOL func_207() // Position - 0xD452 (54354)
{
	return Global_98997;
}

void func_208(var uParam0) // Position - 0xD45E (54366)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD475 (54389)
{
	BOOL flag;
	int num;
	int i;
...
void func_210(int iParam0) // Position - 0xD55D (54621)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_211(Any* panParam0, BOOL bParam1) // Position - 0xD585 (54661)
{
	var unk;
...
void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD7F5 (55285)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_213(int iParam0) // Position - 0xDB4D (56141)
{
...
BOOL func_214(var uParam0) // Position - 0xDB6D (56173)
{
...
BOOL func_215(var uParam0) // Position - 0xDB85 (56197)
{
...
void func_216(var uParam0) // Position - 0xDBAA (56234)
{
	int i;
	int taskSequenceId;
...
void func_217(Object* pobParam0) // Position - 0xDEAE (57006)
{
...
void func_218(var uParam0) // Position - 0xDED9 (57049)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF59 (57177)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE117 (57623)
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE147 (57671)
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE403 (58371)
{
...
BOOL func_223(Ped pedParam0, int iParam1) // Position - 0xE437 (58423)
{
	float xSize;
...
BOOL func_224(Ped pedParam0, int iParam1) // Position - 0xE4AD (58541)
{
	return func_225(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4C5 (58565)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE586 (58758)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE6B2 (59058)
{
...
int func_228() // Position - 0xE777 (59255)
{
	int i;
...
BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE7C1 (59329)
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE852 (59474)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE873 (59507)
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE8B2 (59570)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Ped pedParam0, Ped pedParam1) // Position - 0xE8CD (59597)
{
	int i;
...
BOOL func_234(Ped pedParam0) // Position - 0xE90C (59660)
{
...
BOOL func_235(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE934 (59700)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEA2F (59951)
{
	float entityCoords;
	float num;
...
BOOL func_237(Ped pedParam0, float fParam1) // Position - 0xEB3B (60219)
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEBD0 (60368)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC5E (60510)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xECA6 (60582)
{
...
void func_241(Vehicle veParam0) // Position - 0xECF0 (60656)
{
	int taskSequenceId;
...
BOOL func_242(int iParam0) // Position - 0xED8D (60813)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xEE22 (60962)
{
...
BOOL func_244() // Position - 0xEE61 (61025)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_245() // Position - 0xEE7E (61054)
{
	if (Global_98610 != -1)
...
BOOL func_246(int iParam0) // Position - 0xEEA1 (61089)
{
...
BOOL func_247() // Position - 0xEED5 (61141)
{
...
BOOL func_248(int iParam0) // Position - 0xEF13 (61203)
{
	if (func_118(false))
...
int func_249() // Position - 0xEF3B (61243)
{
...
BOOL func_250(var uParam0) // Position - 0xEF6A (61290)
{
	if (!func_251(uParam0))
		return false;
...
BOOL func_251(var uParam0) // Position - 0xEF89 (61321)
{
	int num;
	int i;
	BOOL flag;
...
void func_252(BOOL bParam0) // Position - 0xF1A4 (61860)
{
...
void func_253(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF1F6 (61942)
{
	if (iParam0 != 198)
	{
		if (Global_79564)
...
void func_254(int iParam0, int iParam1) // Position - 0xF24E (62030)
{
	switch (iParam0)
	{
		case 12:
...
void func_255(int iParam0, BOOL bParam1) // Position - 0xF337 (62263)
{
	if (bParam1)
...
BOOL func_256(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF360 (62304)
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_257() // Position - 0xFCC5 (64709)
{
...
int func_258() // Position - 0xFCF5 (64757)
{
	return Global_33106;
}

int func_259(var uParam0, int iParam1) // Position - 0xFD00 (64768)
{
	int i;
...
void func_260(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13777 (79735)
{
	func_261(pveParam0);
...
void func_261(Vehicle* pveParam0) // Position - 0x137BA (79802)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13856 (79958)
{
...
BOOL func_263(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x138B2 (80050)
{
	Hash model;
...
int func_264(var uParam0, eCharacter echParam1) // Position - 0x13940 (80192)
{
	int num;
...
BOOL func_265(var uParam0) // Position - 0x13986 (80262)
{
	if (func_215(uParam0))
	{
...
BOOL func_266(var uParam0) // Position - 0x139B0 (80304)
{
	int i;
...
void func_267(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x139E1 (80353)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_268(int iParam0) // Position - 0x13A1D (80413)
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x13A6E (80494)
{
	const char* string2;
...
BOOL func_270(int iParam0) // Position - 0x13B27 (80679)
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x13BE8 (80872)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_272(int iParam0, char* sParam1) // Position - 0x13C6D (81005)
{
...
BOOL func_273(int iParam0) // Position - 0x13D4F (81231)
{
...
BOOL func_274(int iParam0) // Position - 0x13D7A (81274)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x13DA5 (81317)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x13DD0 (81360)
{
	if (func_243(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_277() // Position - 0x13E05 (81413)
{
...
BOOL func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13E1F (81439)
{
	int i;
...
BOOL func_279(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x13E84 (81540)
{
	int num;
	char* str;
...
BOOL func_280(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x13EFC (81660)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x13F77 (81783)
{
	char* str;
...
void func_282(char* sParam0) // Position - 0x13FFC (81916)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_285(sParam0))
			func_283();
...
void func_283() // Position - 0x1401F (81951)
{
	Global_21308 = 0;
	func_284();
	return;
...
void func_284() // Position - 0x1402F (81967)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
BOOL func_285(char* sParam0) // Position - 0x14050 (82000)
{
	var string1;
...
struct<6> func_286() // Position - 0x14070 (82032)
{
	var unk;
...
int func_287(var uParam0) // Position - 0x14094 (82068)
{
	if (func_215(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_288(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x140CA (82122)
{
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x140EA (82154)
{
	func_290(&(uParam0->f_41), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x140FC (82172)
{
	int i;
...
void func_291(Object* pobParam0, BOOL bParam1) // Position - 0x1413A (82234)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x14175 (82293)
{
	func_293(&(uParam0->f_35), bParam1);
	return;
}

void func_293(var uParam0, BOOL bParam1) // Position - 0x14187 (82311)
{
	int i;
...
void func_294(Vehicle* pveParam0) // Position - 0x141C4 (82372)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_295(var uParam0, int iParam1) // Position - 0x141FC (82428)
{
	func_296(&(uParam0->f_28), iParam1);
	return;
}

void func_296(var uParam0, int iParam1) // Position - 0x1420E (82446)
{
	int i;
...
void func_297(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1424F (82511)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_298(Ped* ppedParam0) // Position - 0x1429F (82591)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_299(int iParam0) // Position - 0x142E0 (82656)
{
	if (*iParam0 == -1)
		return;
...
void func_300(char* sParam0) // Position - 0x1431D (82717)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_301(var uParam0) // Position - 0x1432F (82735)
{
	*uParam0 = -1;
...
void func_302() // Position - 0x14362 (82786)
{
...
Hash func_303(eCharacter echParam0) // Position - 0x1437C (82812)
{
	if (!func_36(echParam0))
