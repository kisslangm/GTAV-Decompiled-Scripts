...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65F7 (26103)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x663E (26174)
{
...
BOOL func_73(int iParam0) // Position - 0x6699 (26265)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66A9 (26281)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6709 (26377)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AC0 (27328)
{
	return Global_33105;
}

BOOL func_77(int iParam0) // Position - 0x6ACB (27339)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6ADB (27355)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B7D (27517)
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72F7 (29431)
{
...
int func_81() // Position - 0x75F2 (30194)
{
	return Global_2652571.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7601 (30209)
{
...
int func_83() // Position - 0x762B (30251)
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7643 (30275)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7658 (30296)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x766F (30319)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76C7 (30407)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7771 (30577)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7806 (30726)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x784A (30794)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x79CE (31182)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x79DC (31196)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84A4 (33956)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8526 (34086)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x857E (34174)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8587 (34183)
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8843 (34883)
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8853 (34899)
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8870 (34928)
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8880 (34944)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BC3 (35779)
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8BD4 (35796)
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C1A (35866)
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CA0 (36000)
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CD3 (36051)
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D24 (36132)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DC6 (36294)
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DE8 (36328)
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DFF (36351)
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E0C (36364)
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E46 (36422)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E81 (36481)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EBD (36541)
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8ED6 (36566)
{
	int num;
	var textLabel;
...
BOOL func_115() // Position - 0x8F39 (36665)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_116() // Position - 0x8F4F (36687)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F65 (36709)
{
...
BOOL func_118(BOOL bParam0) // Position - 0x8FA7 (36775)
{
...
struct<2> func_119(int iParam0) // Position - 0x8FCF (36815)
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x941C (37916)
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6F4 (42740)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA3A (43578)
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAADF (43743)
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB7A (43898)
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_126() // Position - 0xABA0 (43936)
{
	Global_79819 != 6;
...
void func_127(Ped pedParam0) // Position - 0xABD8 (43992)
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC31 (44081)
{
...
int func_129(Ped pedParam0) // Position - 0xACB4 (44212)
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACE5 (44261)
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACFA (44282)
{
	int num;
...
int func_132() // Position - 0xAD7C (44412)
{
	int i;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADAD (44461)
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADC8 (44488)
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE14 (44564)
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE5D (44637)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE7D (44669)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE9E (44702)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xAEF1 (44785)
{
...
BOOL func_140(int iParam0) // Position - 0xAF6E (44910)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFC1 (44993)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0B7 (45239)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB122 (45346)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB161 (45409)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2B0 (45744)
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2CA (45770)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB323 (45859)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB364 (45924)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB386 (45958)
{
...
BOOL func_150() // Position - 0xB3C5 (46021)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3D3 (46035)
{
	int num;
...
BOOL func_152() // Position - 0xB406 (46086)
{
...
void func_153(int iParam0) // Position - 0xB42D (46125)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB450 (46160)
{
...
void func_155() // Position - 0xB48D (46221)
{
	Global_21308 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB49D (46237)
{
...
BOOL func_157() // Position - 0xB4F4 (46324)
{
...
void func_158() // Position - 0xB516 (46358)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB52B (46379)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB583 (46467)
{
...
void func_161(Vehicle veParam0) // Position - 0xB5DA (46554)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB606 (46598)
{
...
void func_163() // Position - 0xB757 (46935)
{
...
void func_164(int iParam0) // Position - 0xB7A8 (47016)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7DB (47067)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB865 (47205)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8D9 (47321)
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8E7 (47335)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB93E (47422)
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB94D (47437)
{
...
BOOL func_171(int iParam0) // Position - 0xB98E (47502)
{
	int num;
...
void func_172(int iParam0) // Position - 0xB9D3 (47571)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA05 (47621)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB3C (47932)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB8B (48011)
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB9C (48028)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD7D (48509)
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD9F (48543)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDB0 (48560)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xBDF9 (48633)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xBE1D (48669)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC28E (49806)
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2BA (49850)
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC2D1 (49873)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC360 (50016)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCB43 (52035)
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCB5E (52062)
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCBEC (52204)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCC50 (52304)
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xCCE7 (52455)
{
...
BOOL func_191(int iParam0) // Position - 0xCD11 (52497)
{
	eCharacter character;
...
BOOL func_192() // Position - 0xD42E (54318)
{
	return Global_101752.f_1;
}

BOOL func_193() // Position - 0xD43C (54332)
{
	if (Global_98610 != -1)
...
BOOL func_194() // Position - 0xD45F (54367)
{
...
BOOL func_195() // Position - 0xD479 (54393)
{
	if (Global_79825)
		return true;
...
BOOL func_196() // Position - 0xD4A3 (54435)
{
	return Global_101765.f_400 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD4B4 (54452)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD4EC (54508)
{
	return Global_1575086;
}

BOOL func_199() // Position - 0xD4F8 (54520)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD514 (54548)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_204(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD59C (54684)
{
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD5D7 (54743)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD62D (54829)
{
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD6C8 (54984)
{
...
void func_205(var uParam0, var uParam1, char* sParam2) // Position - 0xD702 (55042)
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD9FE (55806)
{
...
BOOL func_207(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xDA4C (55884)
{
	Global_22443 = 0;
...
void func_208() // Position - 0xDD1A (56602)
{
	if (!func_209())
		return;
...
BOOL func_209() // Position - 0xDD51 (56657)
{
...
BOOL func_210(Player plParam0) // Position - 0xDDB4 (56756)
{
	return func_211(plParam0, 20);
}

BOOL func_211(Player plParam0, int iParam1) // Position - 0xDDC4 (56772)
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_212() // Position - 0xDDDC (56796)
{
	int i;
...
void func_213() // Position - 0xDE0E (56846)
{
...
BOOL func_214() // Position - 0xDEA3 (56995)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDF3C (57148)
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_216() // Position - 0xDFDE (57310)
{
	int i;
...
float func_217(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xE036 (57398)
{
	Vector3 entityCoords;
...
void func_218(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE094 (57492)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xE185 (57733)
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xE1C1 (57793)
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xE1FA (57850)
{
	BOOL flag;
	int i;
...
BOOL func_222() // Position - 0xE298 (58008)
{
	return Global_98997;
}

void func_223(var uParam0) // Position - 0xE2A4 (58020)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE2BB (58043)
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0) // Position - 0xE3A3 (58275)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_226(Any* panParam0, BOOL bParam1) // Position - 0xE3CB (58315)
{
	var unk;
...
void func_227(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE63B (58939)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_228(int iParam0) // Position - 0xE993 (59795)
{
...
BOOL func_229(var uParam0) // Position - 0xE9B3 (59827)
{
...
BOOL func_230(var uParam0) // Position - 0xE9CB (59851)
{
...
void func_231(var uParam0) // Position - 0xE9F0 (59888)
{
	int i;
	int taskSequenceId;
...
void func_232(Object* pobParam0) // Position - 0xECEE (60654)
{
...
void func_233(var uParam0) // Position - 0xED19 (60697)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xED99 (60825)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_235(Ped pedParam0, Vehicle veParam1) // Position - 0xEF57 (61271)
{
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEF87 (61319)
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF243 (62019)
{
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF277 (62071)
{
	float xSize;
...
BOOL func_239(Ped pedParam0, int iParam1) // Position - 0xF2ED (62189)
{
	return func_240(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_240(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF305 (62213)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_241(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF3C6 (62406)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_242(Ped pedParam0, int iParam1) // Position - 0xF4F2 (62706)
{
...
int func_243() // Position - 0xF5B7 (62903)
{
	int i;
...
BOOL func_244(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF601 (62977)
{
	var unk;
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF692 (63122)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xF6B3 (63155)
{
	float num;
	float num2;
...
void func_247(var uParam0) // Position - 0xF6F2 (63218)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(Ped pedParam0, Ped pedParam1) // Position - 0xF70D (63245)
{
	int i;
...
BOOL func_249(Ped pedParam0) // Position - 0xF74C (63308)
{
...
BOOL func_250(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF774 (63348)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_251(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF86F (63599)
{
	float entityCoords;
	float num;
...
BOOL func_252(Ped pedParam0, float fParam1) // Position - 0xF97B (63867)
{
	var outProjectile;
	var outCoords;
...
BOOL func_253(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFA10 (64016)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_254(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFA9E (64158)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_255(int iParam0) // Position - 0xFAE6 (64230)
{
...
void func_256(Vehicle veParam0) // Position - 0xFB30 (64304)
{
	int taskSequenceId;
...
BOOL func_257(int iParam0) // Position - 0xFBCD (64461)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_258(int iParam0) // Position - 0xFC62 (64610)
{
...
BOOL func_259() // Position - 0xFCA1 (64673)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_260() // Position - 0xFCBE (64702)
{
	if (Global_98610 != -1)
...
BOOL func_261(int iParam0) // Position - 0xFCE1 (64737)
{
...
BOOL func_262() // Position - 0xFD15 (64789)
{
...
BOOL func_263(int iParam0) // Position - 0xFD53 (64851)
{
	if (func_118(false))
...
BOOL func_264(var uParam0) // Position - 0xFD7B (64891)
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_265(var uParam0) // Position - 0xFDC2 (64962)
{
	int num;
	int i;
	BOOL flag;
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF74 (65396)
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0xFFB7 (65463)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10054 (65620)
{
...
BOOL func_269(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x100B0 (65712)
{
	Hash model;
...
int func_270(var uParam0, eCharacter echParam1) // Position - 0x1013E (65854)
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x10184 (65924)
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x101B5 (65973)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_273(var uParam0) // Position - 0x101F1 (66033)
{
	Hash model;
	BOOL flag;
...
BOOL func_274(int iParam0) // Position - 0x102FC (66300)
{
	var unk;
	eCharacter character;
...
BOOL func_275(int iParam0) // Position - 0x1034D (66381)
{
	const char* string2;
...
BOOL func_276(int iParam0) // Position - 0x10406 (66566)
{
	var unk;
...
BOOL func_277(int iParam0) // Position - 0x104C7 (66759)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_278(int iParam0, char* sParam1) // Position - 0x1054C (66892)
{
...
BOOL func_279(int iParam0) // Position - 0x1062E (67118)
{
...
BOOL func_280(int iParam0) // Position - 0x10659 (67161)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10684 (67204)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_282(int iParam0) // Position - 0x106AF (67247)
{
	if (func_258(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_283() // Position - 0x106E4 (67300)
{
...
BOOL func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x106FE (67326)
{
	int i;
...
BOOL func_285(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10763 (67427)
{
	int num;
	char* str;
...
BOOL func_286(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x107DB (67547)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x10856 (67670)
{
	char* str;
...
void func_288(char* sParam0) // Position - 0x108DD (67805)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_291(sParam0))
			func_289();
...
void func_289() // Position - 0x108FC (67836)
{
	Global_21308 = 0;
	func_290();
	return;
...
void func_290() // Position - 0x1090C (67852)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
BOOL func_291(char* sParam0) // Position - 0x1092D (67885)
{
	var string1;
...
struct<6> func_292() // Position - 0x1094D (67917)
{
	var unk;
...
void func_293(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10971 (67953)
{
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x10991 (67985)
{
	func_295(&(uParam0->f_41), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x109A3 (68003)
{
	int i;
...
void func_296(Object* pobParam0, BOOL bParam1) // Position - 0x109E1 (68065)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_297(var uParam0, BOOL bParam1) // Position - 0x10A1C (68124)
{
	func_298(&(uParam0->f_35), bParam1);
	return;
}

void func_298(var uParam0, BOOL bParam1) // Position - 0x10A2E (68142)
{
	int i;
...
void func_299(Vehicle* pveParam0) // Position - 0x10A6B (68203)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_300(var uParam0, int iParam1) // Position - 0x10AA3 (68259)
{
	func_301(&(uParam0->f_28), iParam1);
	return;
}

void func_301(var uParam0, int iParam1) // Position - 0x10AB5 (68277)
{
	int i;
...
void func_302(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10AF6 (68342)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_303(Ped* ppedParam0) // Position - 0x10B46 (68422)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_304(int iParam0) // Position - 0x10B87 (68487)
{
	if (*iParam0 == -1)
		return;
...
void func_305(char* sParam0) // Position - 0x10BC4 (68548)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_306(var uParam0) // Position - 0x10BD6 (68566)
{
	*uParam0 = -1;
...
void func_307() // Position - 0x10C09 (68617)
{
...
Hash func_308(eCharacter echParam0) // Position - 0x10C23 (68643)
{
	if (!func_36(echParam0))
