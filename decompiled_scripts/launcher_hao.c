...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6625 (26149)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x666C (26220)
{
...
BOOL func_73(int iParam0) // Position - 0x66C7 (26311)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66D7 (26327)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6737 (26423)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AEE (27374)
{
	return Global_33105;
}

BOOL func_77(int iParam0) // Position - 0x6AF9 (27385)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B09 (27401)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BAB (27563)
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7325 (29477)
{
...
int func_81() // Position - 0x7620 (30240)
{
	return Global_2652571.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x762F (30255)
{
...
int func_83() // Position - 0x7659 (30297)
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7671 (30321)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7686 (30342)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x769D (30365)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76F5 (30453)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x779F (30623)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7834 (30772)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7878 (30840)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x79FC (31228)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A0A (31242)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84D5 (34005)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8557 (34135)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85AF (34223)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85B8 (34232)
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8874 (34932)
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8884 (34948)
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88A1 (34977)
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88B1 (34993)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BF4 (35828)
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8C05 (35845)
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C4B (35915)
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CD1 (36049)
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D04 (36100)
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D55 (36181)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DF7 (36343)
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E19 (36377)
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E30 (36400)
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E3D (36413)
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E77 (36471)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EB2 (36530)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EEE (36590)
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F07 (36615)
{
	int num;
	var textLabel;
...
BOOL func_115() // Position - 0x8F6A (36714)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_116() // Position - 0x8F80 (36736)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F96 (36758)
{
...
BOOL func_118(BOOL bParam0) // Position - 0x8FD8 (36824)
{
...
struct<2> func_119(int iParam0) // Position - 0x9000 (36864)
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x944D (37965)
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA725 (42789)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA6B (43627)
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB10 (43792)
{
	var name;
...
void func_125(int iParam0) // Position - 0xABAB (43947)
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_126() // Position - 0xABD1 (43985)
{
	Global_79819 != 6;
...
void func_127(Ped pedParam0) // Position - 0xAC09 (44041)
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC62 (44130)
{
...
int func_129(Ped pedParam0) // Position - 0xACE5 (44261)
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD16 (44310)
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD2B (44331)
{
	int num;
...
int func_132() // Position - 0xADAD (44461)
{
	int i;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADDE (44510)
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADF9 (44537)
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE45 (44613)
{
	int i;
...
BOOL func_136(Vehicle veParam0) // Position - 0xAE8E (44686)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAEAE (44718)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAECF (44751)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xAF22 (44834)
{
...
BOOL func_140(int iParam0) // Position - 0xAF9F (44959)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFF2 (45042)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0E8 (45288)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB153 (45395)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB192 (45458)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2E1 (45793)
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2FB (45819)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB354 (45908)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB395 (45973)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB3B7 (46007)
{
...
BOOL func_150() // Position - 0xB3F6 (46070)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB404 (46084)
{
	int num;
...
BOOL func_152() // Position - 0xB437 (46135)
{
...
void func_153(int iParam0) // Position - 0xB45E (46174)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB481 (46209)
{
...
void func_155() // Position - 0xB4BE (46270)
{
	Global_21308 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB4CE (46286)
{
...
BOOL func_157() // Position - 0xB525 (46373)
{
...
void func_158() // Position - 0xB547 (46407)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB55C (46428)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5B4 (46516)
{
...
void func_161(Vehicle veParam0) // Position - 0xB60B (46603)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB637 (46647)
{
...
void func_163() // Position - 0xB788 (46984)
{
...
void func_164(int iParam0) // Position - 0xB7D9 (47065)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB80C (47116)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB896 (47254)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB90A (47370)
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB918 (47384)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB96F (47471)
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB97E (47486)
{
...
BOOL func_171(int iParam0) // Position - 0xB9BF (47551)
{
	int num;
...
void func_172(int iParam0) // Position - 0xBA04 (47620)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA36 (47670)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB6D (47981)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBBC (48060)
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBBCD (48077)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBDAE (48558)
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBDD0 (48592)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDE1 (48609)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xBE2A (48682)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE4E (48718)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC635 (50741)
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC650 (50768)
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6DE (50910)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC742 (51010)
{
...
BOOL func_186(int iParam0) // Position - 0xC7D9 (51161)
{
	eCharacter character;
...
BOOL func_187() // Position - 0xCEF6 (52982)
{
	return Global_101752.f_1;
}

BOOL func_188() // Position - 0xCF04 (52996)
{
	if (Global_98610 != -1)
...
BOOL func_189() // Position - 0xCF27 (53031)
{
...
BOOL func_190() // Position - 0xCF41 (53057)
{
	if (Global_79825)
		return true;
...
BOOL func_191() // Position - 0xCF6B (53099)
{
	return Global_101765.f_400 > 0;
}

BOOL func_192(int iParam0, int iParam1) // Position - 0xCF7C (53116)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCFB4 (53172)
{
	return Global_1575086;
}

BOOL func_194() // Position - 0xCFC0 (53184)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCFDC (53212)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_199(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD064 (53348)
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD09F (53407)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0F5 (53493)
{
...
float func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD190 (53648)
{
...
void func_200(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1CA (53706)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(int iParam0, BOOL bParam1) // Position - 0xD2BB (53947)
{
	if (iParam0 == -1)
		return;
...
int func_202(int iParam0) // Position - 0xD2F7 (54007)
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_203(var uParam0, int iParam1) // Position - 0xD330 (54064)
{
	BOOL flag;
	int i;
...
BOOL func_204() // Position - 0xD3CE (54222)
{
	return Global_98997;
}

void func_205(var uParam0) // Position - 0xD3DA (54234)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD3F1 (54257)
{
	BOOL flag;
	int num;
	int i;
...
void func_207(int iParam0) // Position - 0xD4D9 (54489)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
void func_208(var uParam0) // Position - 0xD501 (54529)
{
	int i;
	int taskSequenceId;
...
void func_209(Vehicle veParam0) // Position - 0xD805 (55301)
{
	int taskSequenceId;
...
void func_210(Object* pobParam0) // Position - 0xD8A2 (55458)
{
...
BOOL func_211(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xD8CD (55501)
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_212(Vehicle veParam0) // Position - 0xD906 (55558)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_213(Any* panParam0, BOOL bParam1) // Position - 0xD930 (55600)
{
	var unk;
...
void func_214(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDBA0 (56224)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_215(int iParam0) // Position - 0xDEF8 (57080)
{
...
BOOL func_216(var uParam0) // Position - 0xDF18 (57112)
{
...
BOOL func_217(var uParam0) // Position - 0xDF30 (57136)
{
...
void func_218(var uParam0) // Position - 0xDF55 (57173)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDFD5 (57301)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE193 (57747)
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE1C3 (57795)
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE47F (58495)
{
...
BOOL func_223(Vehicle veParam0, int iParam1) // Position - 0xE4B3 (58547)
{
	float xSize;
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE529 (58665)
{
	return func_225(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE541 (58689)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE602 (58882)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE72E (59182)
{
...
int func_228() // Position - 0xE7F3 (59379)
{
	int i;
...
BOOL func_229(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE83D (59453)
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE8CE (59598)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE8EF (59631)
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE92E (59694)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Vehicle veParam0, Ped pedParam1) // Position - 0xE949 (59721)
{
	int i;
...
BOOL func_234(Vehicle veParam0) // Position - 0xE988 (59784)
{
...
BOOL func_235(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE9B0 (59824)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEAAB (60075)
{
	float entityCoords;
	float num;
...
BOOL func_237(Vehicle veParam0, float fParam1) // Position - 0xEBB7 (60343)
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEC4C (60492)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xECDA (60634)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xED22 (60706)
{
...
BOOL func_241(int iParam0) // Position - 0xED6C (60780)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_242(int iParam0) // Position - 0xEE01 (60929)
{
...
BOOL func_243() // Position - 0xEE40 (60992)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_244() // Position - 0xEE5D (61021)
{
	if (Global_98610 != -1)
...
BOOL func_245(int iParam0) // Position - 0xEE80 (61056)
{
...
BOOL func_246() // Position - 0xEEB4 (61108)
{
...
BOOL func_247(int iParam0) // Position - 0xEEF2 (61170)
{
	if (func_118(false))
...
BOOL func_248(var uParam0) // Position - 0xEF1A (61210)
{
	if (!func_249(uParam0))
		return false;
...
BOOL func_249(var uParam0) // Position - 0xEF39 (61241)
{
	int num;
	int i;
	int sceneID;
...
void func_250(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3A3 (62371)
{
	func_210(pobParam0);
...
void func_251(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3CA (62410)
{
	func_252(pveParam0);
...
void func_252(Vehicle* pveParam0) // Position - 0xF40D (62477)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_253(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF4A9 (62633)
{
...
BOOL func_254(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF505 (62725)
{
	Hash model;
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xF593 (62867)
{
	int num;
...
BOOL func_256(var uParam0) // Position - 0xF5D9 (62937)
{
	int i;
...
BOOL func_257(int iParam0) // Position - 0xF60A (62986)
{
	int i;
...
BOOL func_258(int iParam0) // Position - 0xF672 (63090)
{
	var unk;
	eCharacter character;
...
BOOL func_259(int iParam0) // Position - 0xF6C3 (63171)
{
	const char* string2;
...
BOOL func_260(int iParam0) // Position - 0xF77C (63356)
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF83D (63549)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_262(int iParam0, char* sParam1) // Position - 0xF8C2 (63682)
{
...
BOOL func_263(int iParam0) // Position - 0xF9A4 (63908)
{
...
BOOL func_264(int iParam0) // Position - 0xF9CF (63951)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF9FA (63994)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xFA25 (64037)
{
	if (func_242(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_267() // Position - 0xFA5A (64090)
{
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFA74 (64116)
{
	int i;
...
BOOL func_269(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFAD9 (64217)
{
	int num;
	char* str;
...
BOOL func_270(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFB51 (64337)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFBCC (64460)
{
	if (bParam1)
	{
...
void func_272(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFC20 (64544)
{
...
void func_273(var uParam0, BOOL bParam1) // Position - 0xFC40 (64576)
{
	func_274(&(uParam0->f_41), bParam1);
	return;
}

void func_274(var uParam0, BOOL bParam1) // Position - 0xFC52 (64594)
{
	int i;
...
void func_275(Object* pobParam0, BOOL bParam1) // Position - 0xFC90 (64656)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_276(var uParam0, BOOL bParam1) // Position - 0xFCCB (64715)
{
	func_277(&(uParam0->f_35), bParam1);
	return;
}

void func_277(var uParam0, BOOL bParam1) // Position - 0xFCDD (64733)
{
	int i;
...
void func_278(Vehicle* pveParam0) // Position - 0xFD1A (64794)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_279(var uParam0, int iParam1) // Position - 0xFD52 (64850)
{
	func_280(&(uParam0->f_28), iParam1);
	return;
}

void func_280(var uParam0, int iParam1) // Position - 0xFD64 (64868)
{
	int i;
...
void func_281(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFDA5 (64933)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_282(Ped* ppedParam0) // Position - 0xFDF5 (65013)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_283(int iParam0) // Position - 0xFE36 (65078)
{
	if (*iParam0 == -1)
		return;
...
void func_284(char* sParam0) // Position - 0xFE73 (65139)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_285(var uParam0) // Position - 0xFE85 (65157)
{
	*uParam0 = -1;
...
void func_286() // Position - 0xFEB8 (65208)
{
...
Hash func_287(eCharacter echParam0) // Position - 0xFED2 (65234)
{
	if (!func_36(echParam0))
