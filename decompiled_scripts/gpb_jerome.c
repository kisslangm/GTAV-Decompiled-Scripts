...
BOOL func_95() // Position - 0x2EF6 (12022)
{
	return true;
}

float func_96(Ped pedParam0, Ped pedParam1) // Position - 0x2EFF (12031)
{
	return func_84(pedParam0, pedParam1, true);
}

void func_97(int iParam0) // Position - 0x2F10 (12048)
{
	int num;
...
int func_98(int iParam0) // Position - 0x2F41 (12097)
{
	int i;
	int num;
...
int func_99(int iParam0, BOOL bParam1) // Position - 0x2F72 (12146)
{
	if (!func_77(iParam0))
	{
		!bParam1;
...
void func_100(int iParam0, int iParam1) // Position - 0x3025 (12325)
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_101(int iParam0, BOOL bParam1) // Position - 0x3036 (12342)
{
	if (iParam0 == 1)
		TASK::TASK_PLAY_ANIM(pedLocal_238, &uLocal_322, &uLocal_216, 2f, -2f, -1, 0, 0, false, false, false);
	else
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x30A8 (12456)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_103() // Position - 0x30C9 (12489)
{
	func_104();
	return;
}

void func_104() // Position - 0x30D5 (12501)
{
	PED::SET_PED_PROP_INDEX(pedLocal_238, 1, 0, 0, false, 1);
	return;
}

void func_105() // Position - 0x30E8 (12520)
{
...
BOOL func_106() // Position - 0x318D (12685)
{
...
BOOL func_107() // Position - 0x31AA (12714)
{
	if (Global_98610 != -1)
...
BOOL func_108() // Position - 0x31CD (12749)
{
	if (Global_44199 == 15)
		return false;
...
BOOL func_109() // Position - 0x31E2 (12770)
{
	return true;
}

BOOL func_110(int iParam0) // Position - 0x31EB (12779)
{
	return func_111(Global_114162.f_20121, iParam0);
}

BOOL func_111(int iParam0, int iParam1) // Position - 0x3200 (12800)
{
	return iParam0 && iParam1 != false;
}

int func_112(const char* sParam0) // Position - 0x320F (12815)
{
...
void func_113(int iParam0) // Position - 0x3336 (13110)
{
	var string1;
...
void func_114(Blip* pblParam0) // Position - 0x3405 (13317)
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_115() // Position - 0x3425 (13349)
{
	var unk;
...
void func_116() // Position - 0x3449 (13385)
{
	func_117();
	return;
}

void func_117() // Position - 0x3455 (13397)
{
	return;
}

void func_118() // Position - 0x345D (13405)
{
	if (iLocal_243 == -1)
