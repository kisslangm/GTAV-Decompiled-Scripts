...
BOOL func_8(Player plParam0, int iParam1) // Position - 0x65B (1627)
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x673 (1651)
{
	return -1;
}

void func_10() // Position - 0x67C (1660)
{
	int i;
...
void func_11() // Position - 0x6AD (1709)
{
...
BOOL func_12() // Position - 0x742 (1858)
{
...
BOOL func_13() // Position - 0x769 (1897)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x802 (2050)
{
	if (func_21(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x8A4 (2212)
{
	func_16();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_16() // Position - 0x8BD (2237)
{
...
BOOL func_17(eCharacter echParam0) // Position - 0x9BA (2490)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x9C6 (2502)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xA03 (2563)
{
...
Hash func_20(eCharacter echParam0) // Position - 0xA28 (2600)
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_21(int iParam0) // Position - 0xA37 (2615)
{
	return Global_44199 == iParam0;
}

void func_22() // Position - 0xA45 (2629)
{
	int i;
...
BOOL func_23(int iParam0, int iParam1) // Position - 0xA9C (2716)
{
	switch (iParam0)
	{
		case 5:
...
void func_24() // Position - 0xAD4 (2772)
{
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB2B (2859)
{
...
BOOL func_26() // Position - 0xB81 (2945)
{
	float synchronizedScenePhase;
...
BOOL func_27() // Position - 0xD9D (3485)
{
	if (!func_28())
		return true;
...
BOOL func_28() // Position - 0xDB2 (3506)
{
...
int func_29(int iParam0, Ped pedParam1) // Position - 0xE07 (3591)
{
...
Ped func_30(Ped pedParam0) // Position - 0xEEB (3819)
{
	return pedParam0;
}

BOOL func_31(int iParam0, int iParam1) // Position - 0xEF5 (3829)
{
	return iParam0 && iParam1 != false;
}

int func_32() // Position - 0xF04 (3844)
{
	func_16();
...
void func_33() // Position - 0xF4A (3914)
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_34() // Position - 0xF8A (3978)
{
	func_35(Global_101436 - 1);
	return;
}

void func_35(int iParam0) // Position - 0xF9C (3996)
{
	Global_101436 = iParam0;
	return;
}

void func_36() // Position - 0xFAA (4010)
{
	func_35(0);
	return;
}

void func_37() // Position - 0xFB7 (4023)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1092 (4242)
{
...
void func_39(Ped pedParam0, Hash hParam1) // Position - 0x112D (4397)
{
...
void func_40() // Position - 0x1163 (4451)
{
	var unk;
	int num;
	var unk117;
...
BOOL func_41(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Position - 0x125F (4703)
{
	*uParam4 = 9;
	*uParam5 = 8;
...
void func_42(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5) // Position - 0x1970 (6512)
{
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x4D08 (19720)
{
...
void func_45(var uParam0) // Position - 0x4D32 (19762)
{
	func_44(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_46(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x4D50 (19792)
{
	int num;
...
BOOL func_47(var uParam0) // Position - 0x4F43 (20291)
{
	int num;
	Vector3 entityCoords;
	float num2;
...
BOOL func_48(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x4FFB (20475)
{
	if (bParam6)
...
BOOL func_49(int iParam0, var uParam1, char* sParam2) // Position - 0x5042 (20546)
{
	var unk;
	int num;
	var unk4;
...
BOOL func_50(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x7549 (30025)
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x949B (38043)
{
...
BOOL func_52(int iParam0, var uParam1, var uParam2) // Position - 0x94B9 (38073)
{
	switch (iParam0)
	{
		case 11:
...
char* func_53(int iParam0) // Position - 0x9E28 (40488)
{
	switch (iParam0)
	{
...
void func_54() // Position - 0x9EBA (40634)
{
	if (iLocal_293 != 0)
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
