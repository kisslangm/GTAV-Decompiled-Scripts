...
int func_31() // Position - 0xDB1 (3505)
{
...
BOOL func_68(var uParam0) // Position - 0x18C9 (6345)
{
	if (uParam0->f_20 == 0)
		return true;
...
Hash func_69() // Position - 0x194A (6474)
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

var func_70(BOOL bParam0, var uParam1, var uParam2) // Position - 0x195A (6490)
{
	if (bParam0)
		return uParam1;
...
void func_71(var uParam0) // Position - 0x1971 (6513)
{
	func_59();
...
void func_72(var uParam0) // Position - 0x198B (6539)
{
	func_168(uParam0);
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A32 (6706)
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_74() // Position - 0x1AA7 (6823)
{
	func_34(0);
	func_35(4, 1, -1);
	func_35(6, true, -1);
...
void func_75() // Position - 0x1AFE (6910)
{
	Global_1574755 = true;
...
void func_76(var uParam0) // Position - 0x1B27 (6951)
{
	var unk;
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C22 (7202)
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2184 (8580)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Vehicle veParam0) // Position - 0x2194 (8596)
{
	Hash entityModel;
...
BOOL func_80(Hash hParam0) // Position - 0x21DA (8666)
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_81(Hash hParam0) // Position - 0x2284 (8836)
{
	return func_139(hParam0) && !func_82(hParam0);
}

BOOL func_82(Hash hParam0) // Position - 0x229E (8862)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x22D3 (8915)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x23DA (9178)
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Position - 0x2465 (9317)
{
	Hash eventData;
...
int func_86(BOOL bParam0, BOOL bParam1) // Position - 0x24A6 (9382)
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Position - 0x250B (9483)
{
	int i;
...
BOOL func_88(int iParam0) // Position - 0x2546 (9542)
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2556 (9558)
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x25B6 (9654)
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x25E5 (9701)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x25FA (9722)
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x262E (9774)
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x29E5 (10725)
{
	return Global_33105;
}

int func_95(int iParam0) // Position - 0x29F0 (10736)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_96() // Position - 0x2D33 (11571)
{
	return Global_101765.f_400 > 0;
}

int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2D44 (11588)
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2DC1 (11713)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2E4E (11854)
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2EAA (11946)
{
	func_104();
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3155 (12629)
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x317E (12670)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8F4A (36682)
{
	if (bParam6)
...
void func_104() // Position - 0x8F91 (36753)
{
	Global_1944325 = 0;
...
BOOL func_105(Vehicle veParam0) // Position - 0x900A (36874)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x9042 (36930)
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x908A (37002)
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x91E7 (37351)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x9532 (38194)
{
...
int func_110(Player plParam0) // Position - 0x955E (38238)
{
...
int func_111(Player plParam0) // Position - 0x957B (38267)
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x959E (38302)
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x95E2 (38370)
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
int func_114() // Position - 0x960E (38414)
{
	int num;
...
BOOL func_115(BOOL bParam0) // Position - 0x961B (38427)
{
	return func_116(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x962D (38445)
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x963E (38462)
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x969A (38554)
{
	if (func_11(plParam0))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x96E9 (38633)
{
	int num;
	int num2;
...
int func_120(int iParam0) // Position - 0x9747 (38727)
{
	return iParam0 % 32;
}

int func_121(int iParam0) // Position - 0x9754 (38740)
{
	int num;
...
int func_122(int iParam0) // Position - 0x976B (38763)
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x9798 (38808)
{
	return iParam0 / 32;
}

BOOL func_124(Player plParam0) // Position - 0x97A5 (38821)
{
...
BOOL func_125(Player plParam0) // Position - 0x97DA (38874)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_126(int iParam0) // Position - 0x9821 (38945)
{
	switch (iParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9D56 (40278)
{
	int num;
	int num2;
...
BOOL func_128(int iParam0, var uParam1) // Position - 0x9D77 (40311)
{
	*uParam1 = -1;
...
int func_129(int iParam0) // Position - 0xA039 (41017)
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0xA0D7 (41175)
{
...
BOOL func_131() // Position - 0xA2B9 (41657)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA301 (41729)
{
	var gamerHandle;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA316 (41750)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA337 (41783)
{
	*uParam1 = -1f;
...
void func_135(Vehicle veParam0) // Position - 0xA638 (42552)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA66A (42602)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA69E (42654)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA6BB (42683)
{
...
BOOL func_139(Hash hParam0) // Position - 0xAC0C (44044)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAC9B (44187)
{
	int num;
	int num2;
	int i;
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xB39E (45982)
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xB40F (46095)
{
	if (bParam0)
...
BOOL func_143() // Position - 0xB429 (46121)
{
...
BOOL func_144(int iParam0) // Position - 0xB4B8 (46264)
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xB4DC (46300)
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xB4FA (46330)
{
	return IS_BIT_SET(Global_1887694[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_147(int iParam0) // Position - 0xB512 (46354)
{
	return func_148(&(Global_2672942.f_194), iParam0);
}

BOOL func_148(var uParam0, int iParam1) // Position - 0xB526 (46374)
{
	int num;
	int num2;
	int num3;
...
int func_149(var uParam0, var uParam1, var uParam2) // Position - 0xB549 (46409)
{
	int i;
	int modType;
...
BOOL func_150(Vehicle veParam0) // Position - 0xB747 (46919)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_151(var uParam0) // Position - 0xB821 (47137)
{
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xB88C (47244)
{
	int value;
	int value2;
	float num;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xB975 (47477)
{
	int i;
...
BOOL func_154(Hash hParam0) // Position - 0xB9D7 (47575)
{
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xBA02 (47618)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBDE1 (48609)
{
...
BOOL func_157() // Position - 0xBE05 (48645)
{
	return true;
}

void func_158(Vehicle veParam0, int iParam1) // Position - 0xBE12 (48658)
{
	int vehicleMod;
...
BOOL func_159(int iParam0) // Position - 0xBE8A (48778)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160() // Position - 0xBEAA (48810)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_161(Vehicle veParam0) // Position - 0xBEBB (48827)
{
	int _int;
...
int func_162(var uParam0) // Position - 0xBF00 (48896)
{
...
BOOL func_163(int iParam0) // Position - 0xBF20 (48928)
{
	switch (iParam0)
	{
		case 161:
...
int func_164(int iParam0) // Position - 0xBF73 (49011)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_165(Vehicle veParam0) // Position - 0xC024 (49188)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC0AB (49323)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC0F8 (49400)
{
...
void func_168(var uParam0) // Position - 0xC119 (49433)
{
...
void func_169(var uParam0) // Position - 0xC167 (49511)
{
...
Vector3 func_170(float fParam0, var uParam1, var uParam2) // Position - 0xC221 (49697)
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_171(var uParam0) // Position - 0xC24E (49742)
{
	Player player;
...
void func_172(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC326 (49958)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_173(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC48F (50319)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_174(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD766 (55142)
{
	Hash entityModel;
	int num;
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xDF8C (57228)
{
	int num;
	int num2;
...
int func_176(int iParam0, int iParam1) // Position - 0xDFCB (57291)
{
	int num;
	int num2;
...
int func_177() // Position - 0xE011 (57361)
{
	return Global_33106;
}

int func_178(int iParam0) // Position - 0xE01C (57372)
{
	int num;
	int num2;
...
char* func_179(int iParam0) // Position - 0xE3BD (58301)
{
	switch (iParam0)
	{
		case 0:
...
int func_180(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE9FA (59898)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_181(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xFA2C (64044)
{
	Hash entityModel;
	int num;
...
void func_182(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12999 (76185)
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_183() // Position - 0x12A2B (76331)
{
...
BOOL func_184() // Position - 0x12A5D (76381)
{
	return true;
}

int func_185() // Position - 0x12A66 (76390)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_186() // Position - 0x12B1C (76572)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x12C55 (76885)
{
	int profileSetting;
...
int func_188() // Position - 0x12D0D (77069)
{
	return 1;
}

int func_189() // Position - 0x12D16 (77078)
{
	return 1;
}

void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12D1F (77087)
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x12FD4 (77780)
{
...
Hash func_192(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13294 (78484)
{
	var outProp;
	int componentId;
	int num;
...
int func_193(Hash hParam0, int iParam1) // Position - 0x133AE (78766)
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x13755 (79701)
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x13805 (79877)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13866 (79974)
{
	int i;
	int j;
...
int func_197(Ped pedParam0, int iParam1) // Position - 0x13907 (80135)
{
...
int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13967 (80231)
{
	ePedComponentType componentId;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x139BE (80318)
{
	int pedPropIndex;
...
int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x13A05 (80389)
{
	Hash entityModel;
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13B01 (80641)
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13C3F (80959)
{
	var outfit;
	int i;
	int num;
...
int func_203(Hash hParam0) // Position - 0x13CFA (81146)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x13D59 (81241)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, int iParam2) // Position - 0x13DDF (81375)
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1423B (82491)
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x142E4 (82660)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1438C (82828)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x143DF (82911)
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x149E3 (84451)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14C60 (85088)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15085 (86149)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2) // Position - 0x15378 (86904)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15411 (87057)
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15D40 (89408)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x15E6A (89706)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x15EB2 (89778)
{
	int i;
	var unk;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17CFA (97530)
{
	int num;
	Hash outfit;
...
int func_219(int iParam0) // Position - 0x17EE4 (98020)
{
	switch (iParam0)
	{
		case 0:
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17F94 (98196)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x18007 (98311)
{
	func_267();
...
void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x18048 (98376)
{
	switch (iParam0)
	{
		case 2:
...
void func_223(int iParam0) // Position - 0x18154 (98644)
{
	BOOL flag;
	int num;
	var unk;
...
void func_224(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1830F (99087)
{
	int num;
	int num2;
...
BOOL func_225(int iParam0, int iParam1, var uParam2) // Position - 0x186B1 (100017)
{
	*uParam2 = 979;
...
int func_226(int iParam0, int iParam1) // Position - 0x18AB6 (101046)
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1) // Position - 0x18EB1 (102065)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x192AC (103084)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A14F (106831)
{
	int num;
	int num2;
	int num3;
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A18D (106893)
{
...
BOOL func_231(int iParam0) // Position - 0x1CDB1 (118193)
{
	return Global_44199 == iParam0;
}

int func_232(int iParam0) // Position - 0x1CDBF (118207)
{
	switch (iParam0)
	{
		case -1:
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1CE93 (118419)
{
	int num;
...
void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CEB3 (118451)
{
	int num;
	int num2;
	Hash outfit;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D13A (119098)
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D23D (119357)
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1D51C (120092)
{
	BOOL flag;
	int value;
	var unk;
...
void func_302() // Position - 0x34F5A (216922)
{
...
void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x34FA4 (216996)
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x34FD4 (217044)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x35001 (217089)
{
