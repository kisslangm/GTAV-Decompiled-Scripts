...
BOOL func_93(Player plParam0, int iParam1) // Position - 0x3BE6 (15334)
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x3BFE (15358)
{
	return -1;
}

void func_95() // Position - 0x3C07 (15367)
{
	int i;
...
void func_96() // Position - 0x3C38 (15416)
{
...
BOOL func_97() // Position - 0x3CCD (15565)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x3D66 (15718)
{
	if (func_230(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x3E08 (15880)
{
	func_100();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_100() // Position - 0x3E21 (15905)
{
...
BOOL func_101(eCharacter echParam0) // Position - 0x3F1E (16158)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3F2A (16170)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3F67 (16231)
{
...
Hash func_104(eCharacter echParam0) // Position - 0x3F8C (16268)
{
	return Global_2201[echParam0 /*29*/];
}

void func_105() // Position - 0x3F9B (16283)
{
	int i;
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3FF2 (16370)
{
	switch (iParam0)
	{
		case 5:
...
void func_107() // Position - 0x4031 (16433)
{
...
void func_108(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4088 (16520)
{
...
void func_109(var uParam0) // Position - 0x40DE (16606)
{
	int num;
	int num2;
	int i;
...
void func_110(var uParam0, int iParam1) // Position - 0x4E86 (20102)
{
	if (!func_19())
	{
		if (uParam0->f_483 == 0)
...
void func_111(var uParam0, int iParam1) // Position - 0x5096 (20630)
{
...
void func_112(int iParam0) // Position - 0x57C1 (22465)
{
	int num;
...
void func_113(int iParam0, int iParam1) // Position - 0x58BC (22716)
{
	if (iParam0 == 13 || iParam0 == -1)
		return;
...
void func_114(int iParam0, int iParam1) // Position - 0x5901 (22785)
{
...
void func_115(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5946 (22854)
{
	if (bParam2)
...
void func_116(int iParam0) // Position - 0x5984 (22916)
{
	int i;
	int num;
...
void func_117(int iParam0) // Position - 0x5D01 (23809)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_118(BOOL bParam0) // Position - 0x5E49 (24137)
{
...
void func_119() // Position - 0x5E71 (24177)
{
	Global_21308 = 0;
	func_120();
	return;
...
void func_120() // Position - 0x5E81 (24193)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
void func_121() // Position - 0x5EA2 (24226)
{
...
void func_122() // Position - 0x5EB2 (24242)
{
	Global_23848.f_134 = 1;
	return;
}

void func_123(var uParam0) // Position - 0x5EC0 (24256)
{
	Vector3 vector;
	Interior interiorAtCoords;
...
void func_124() // Position - 0x60B2 (24754)
{
	int i;
...
void func_125(BOOL bParam0) // Position - 0x6110 (24848)
{
	if (!bParam0)
...
void func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, var uParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x612E (24878)
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_127() // Position - 0x6226 (25126)
{
	Global_23848.f_5 = 1;
	return;
}

void func_128(Ped pedParam0) // Position - 0x6234 (25140)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0x628D (25229)
{
...
int func_130(Ped pedParam0) // Position - 0x6310 (25360)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0x6341 (25409)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x6356 (25430)
{
	int num;
...
int func_133() // Position - 0x63D8 (25560)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0x6409 (25609)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0x6424 (25636)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0x6470 (25712)
{
	int i;
...
void func_137(var uParam0) // Position - 0x64B9 (25785)
{
	int num;
...
int func_138(int iParam0) // Position - 0x6510 (25872)
{
	int i;
...
BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x654B (25931)
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x6603 (26115)
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0x672E (26414)
{
	eCharacter character;
...
BOOL func_142() // Position - 0x6E4B (28235)
{
	return Global_101752.f_1;
}

BOOL func_143() // Position - 0x6E59 (28249)
{
	if (Global_98610 != -1)
...
BOOL func_144() // Position - 0x6E7C (28284)
{
...
BOOL func_145() // Position - 0x6E96 (28310)
{
	if (Global_79825)
		return true;
...
BOOL func_146() // Position - 0x6EC0 (28352)
{
	return Global_101765.f_400 > 0;
}

BOOL func_147() // Position - 0x6ED1 (28369)
{
	return Global_101765.f_399 > 0;
}

BOOL func_148() // Position - 0x6EE2 (28386)
{
	return Global_1575086;
}

BOOL func_149() // Position - 0x6EEE (28398)
{
...
BOOL func_150(int iParam0) // Position - 0x6F0A (28426)
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x6F61 (28513)
{
	return func_152(iParam0, Global_44199);
}

BOOL func_152(int iParam0, int iParam1) // Position - 0x6F72 (28530)
{
	if (iParam1 == 15)
		return 1;
...
void func_153() // Position - 0x7153 (29011)
{
	var args;
	Vector3 vector;
	...
	if (func_232(18))
	{
		...
		else if (iLocal_41 == -1 && !func_118(false))
		{
			iLocal_41 = MISC::GET_GAME_TIMER() + 1500;
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_41 || func_118(false))
		{
			if (func_118(false))
			{
...
void func_154(int iParam0, BOOL bParam1) // Position - 0x754E (30030)
{
	int i;
	int num;
...
void func_155(char* sParam0) // Position - 0x7714 (30484)
{
...
BOOL func_156(int iParam0) // Position - 0x7738 (30520)
{
	int num;
	int i;
...
BOOL func_157(int iParam0) // Position - 0x7778 (30584)
{
...
void func_158(int iParam0, BOOL bParam1) // Position - 0x77A4 (30628)
{
	int offset;
...
char* func_159(int iParam0) // Position - 0x77ED (30701)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_160(int iParam0) // Position - 0x78D0 (30928)
{
...
void func_161(var uParam0) // Position - 0x78FC (30972)
{
	if (*uParam0 == -1)
		return;
...
void func_162(var uParam0, int iParam1) // Position - 0x7939 (31033)
{
	switch (iParam1)
	{
		case 17:
...
int func_163(var uParam0, int iParam1, int iParam2) // Position - 0x7C82 (31874)
{
	int num;
	var unk;
	var unk99;
...
BOOL func_164(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7D9F (32159)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_165(int iParam0, var uParam1, int iParam2) // Position - 0xB44D (46157)
{
	int num;
...
int func_166(int iParam0, var uParam1, int iParam2) // Position - 0xB6A9 (46761)
{
...
BOOL func_171() // Position - 0xBD76 (48502)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_172() // Position - 0xBD8C (48524)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_173() // Position - 0xBDA2 (48546)
{
	return false;
}

BOOL func_174() // Position - 0xBDAB (48555)
{
	return true;
}

BOOL func_175() // Position - 0xBDB4 (48564)
{
	return true;
}

BOOL func_176() // Position - 0xBDBD (48573)
{
...
BOOL func_178(int iParam0) // Position - 0xBE8E (48782)
{
...
BOOL func_179(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC10E (49422)
{
	if (bParam6)
...
BOOL func_180(int iParam0, var uParam1, var uParam2) // Position - 0xC155 (49493)
{
	switch (iParam0)
	{
		case 11:
...
var func_181() // Position - 0xCAC4 (51908)
{
	var unk;
...
void func_182(var uParam0, int iParam1) // Position - 0xCB0A (51978)
{
	if (iParam1 <= 0)
		return;
...
void func_183(var uParam0, int iParam1) // Position - 0xCB90 (52112)
{
...
void func_184(var uParam0, int iParam1) // Position - 0xCBC3 (52163)
{
	int num;
	int num2;
...
int func_185(int iParam0, int iParam1) // Position - 0xCC14 (52244)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_186(int iParam0) // Position - 0xCCB6 (52406)
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_187(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCCD8 (52440)
{
	if (bParam0)
		return uParam1;
...
int func_188(int iParam0) // Position - 0xCCEF (52463)
{
	return iParam0 & 15;
}

void func_189(var uParam0, int iParam1) // Position - 0xCCFC (52476)
{
...
void func_190(var uParam0, int iParam1) // Position - 0xCD36 (52534)
{
...
void func_191(var uParam0, int iParam1) // Position - 0xCD71 (52593)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_192(var uParam0, int iParam1) // Position - 0xCDAD (52653)
{
	int i;
	int num;
	var unk;
...
void func_193(var uParam0) // Position - 0xCF73 (53107)
{
	*uParam0 = -15;
	return;
}

int func_194() // Position - 0xCF81 (53121)
{
	if (func_118(false))
		return 0;
...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCFCC (53196)
{
	if (bParam0)
	{
...
BOOL func_196() // Position - 0xD11B (53531)
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_197(Player plParam0, int iParam1) // Position - 0xD135 (53557)
{
	BOOL flag;
...
int func_198(int iParam0, BOOL bParam1) // Position - 0xD18E (53646)
{
	int num;
	int num2;
...
int func_199() // Position - 0xD1CF (53711)
{
	return Global_1574926;
}

BOOL func_200(Player plParam0) // Position - 0xD1DB (53723)
{
	Player player;
...
BOOL func_201(Player plParam0) // Position - 0xD1FD (53757)
{
...
BOOL func_202() // Position - 0xD23C (53820)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_203(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD24A (53834)
{
	int num;
...
void func_204(int iParam0) // Position - 0xD27D (53885)
{
	if (iParam0 == 1)
...
void func_205() // Position - 0xD2A0 (53920)
{
...
void func_206() // Position - 0xDBBF (56255)
{
	func_85(1, 0, true);
	func_85(2, 0, true);
	func_214(&uLocal_44);
...
void func_207(var uParam0) // Position - 0xDBE1 (56289)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_208(var uParam0) // Position - 0xDC27 (56359)
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC63 (56419)
{
...
int func_210(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xDCFE (56574)
{
	int i;
...
void func_211(var uParam0, int iParam1) // Position - 0xDE35 (56885)
{
	int i;
...
BOOL func_212(int iParam0) // Position - 0xDE84 (56964)
{
	if (Global_44199 == 15)
		return false;
...
void func_213() // Position - 0xDEA6 (56998)
{
	Global_101752 = 1;
	return;
}

void func_214(var uParam0) // Position - 0xDEB3 (57011)
{
...
BOOL func_215(int iParam0) // Position - 0xDF02 (57090)
{
	switch (iParam0)
	{
		case 0:
...
int func_216() // Position - 0xDF6F (57199)
{
	return Global_79827;
}

BOOL func_217(var uParam0) // Position - 0xDF7B (57211)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_207(uParam0);
...
void func_218(var uParam0) // Position - 0xDFA4 (57252)
{
...
void func_219(var uParam0, float fParam1, float fParam2) // Position - 0xE00E (57358)
{
	float num;
...
void func_220(var uParam0) // Position - 0xE0DF (57567)
{
...
void func_221(var uParam0) // Position - 0xE15D (57693)
{
	int i;
...
void func_222(var uParam0) // Position - 0xE1B7 (57783)
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_223(var uParam0, var uParam1) // Position - 0xE2ED (58093)
{
	float num;
	float num2;
	float num3;
...
void func_224(var uParam0) // Position - 0xE36B (58219)
{
	int i;
	int num;
	int num2;
...
void func_225(var uParam0) // Position - 0xE448 (58440)
{
	int num;
	int value;
	int i;
...
BOOL func_226(var uParam0) // Position - 0xE588 (58760)
{
...
void func_228(var uParam0) // Position - 0xE6AC (59052)
{
	int i;
	int num;
	BOOL value;
...
void func_229(var uParam0) // Position - 0xE8ED (59629)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
BOOL func_230(int iParam0) // Position - 0xE911 (59665)
{
	return Global_44199 == iParam0;
}

BOOL func_231(int iParam0) // Position - 0xE91F (59679)
{
	int i;
...
BOOL func_232(int iParam0) // Position - 0xE987 (59783)
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_233(var uParam0, int iParam1) // Position - 0xE9B4 (59828)
{
	var unk;
	var unk4;
...
void func_234(var uParam0, var uParam1) // Position - 0xEA80 (60032)
{
...
void func_235(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xED26 (60710)
{
	var unk;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED9F (60831)
{
	if (uParam0->f_33 < 20)
	{
...
void func_237(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xEDE3 (60899)
{
	var unk;
...
void func_238(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xEE33 (60979)
{
	if (uParam0->f_117 < 22)
	{
...
void func_239(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xEE83 (61059)
{
	var unk;
	var unk3;
...
void func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0xEF1D (61213)
{
	var unk;
	var unk5;
	var unk9;
...
void func_241(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xEFC1 (61377)
{
	uParam0->f_9 = fParam1;
...
void func_243(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF0A9 (61609)
{
	uParam0->f_1 = iParam1;
...
var func_244(var uParam0, var uParam1) // Position - 0xF115 (61717)
{
	if (uParam0 > uParam1)
		return uParam0;
...
int func_245(int iParam0) // Position - 0xF12B (61739)
{
	int num;
	int offset;
...
void func_246() // Position - 0xF182 (61826)
{
