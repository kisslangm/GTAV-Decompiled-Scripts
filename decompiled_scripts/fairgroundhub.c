...
void main() // Position - 0x0 (0)
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(num[i]))
		{
			...
			ENTITY::SET_ENTITY_INVINCIBLE(num[i], true, false);
		}
	}
...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x2A1 (673)
{
	int i;
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9E3 (2531)
{
...
void func_3(Vehicle veParam0) // Position - 0xA3A (2618)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_4(BOOL bParam0, BOOL bParam1) // Position - 0xA66 (2662)
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xBB7 (2999)
{
...
BOOL func_6(BOOL bParam0) // Position - 0xC3C (3132)
{
	if (bParam0)
		if (func_7())
			return true;
...
BOOL func_7() // Position - 0xC62 (3170)
{
	if (Global_113104)
		return true;
...
void func_8() // Position - 0xC94 (3220)
{
	Global_23848.f_6 = 1;
	return;
}

BOOL func_9(var uParam0) // Position - 0xCA2 (3234)
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
...
float func_10(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xD4B (3403)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_11() // Position - 0xD62 (3426)
{
	Vehicle vehiclePedIsIn;
...
int func_12(var uParam0, const char* sParam1, int iParam2) // Position - 0xD9C (3484)
{
...
void func_13(const char* sParam0, int iParam1) // Position - 0xDE8 (3560)
{
...
BOOL func_14(var uParam0) // Position - 0xE04 (3588)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xE5E (3678)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_16(const char* sParam0, int iParam1) // Position - 0xE71 (3697)
{
...
BOOL func_17(var uParam0) // Position - 0xE8A (3722)
{
	var unk;
...
struct<8> func_18(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xF2E (3886)
{
	var unk;
	var unk9;
...
Vector3 func_19(float fParam0, var uParam1, var uParam2) // Position - 0xF90 (3984)
{
	float num;
	float num2;
...
BOOL func_20(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFCF (4047)
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_21(var uParam0, const char* sParam1) // Position - 0xFED (4077)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_22(const char* sParam0) // Position - 0x1036 (4150)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_23(var uParam0) // Position - 0x104C (4172)
{
	if (func_14(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_24() // Position - 0x1079 (4217)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_25(Vehicle veParam0, int iParam1) // Position - 0x10CD (4301)
{
	int num;
...
BOOL func_26(Vehicle veParam0) // Position - 0x1169 (4457)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x1193 (4499)
{
...
BOOL func_28(Vehicle veParam0) // Position - 0x11B4 (4532)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_29() // Position - 0x11F7 (4599)
{
...
int func_30(int iParam0) // Position - 0x1245 (4677)
{
	return Global_61500[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1254 (4692)
{
	func_32();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_32() // Position - 0x126D (4717)
{
...
BOOL func_33(eCharacter echParam0) // Position - 0x136A (4970)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1376 (4982)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x13B3 (5043)
{
...
Hash func_36(eCharacter echParam0) // Position - 0x13D8 (5080)
{
	return Global_2201[echParam0 /*29*/];
}

int func_37(Player plParam0) // Position - 0x13E7 (5095)
{
	int num;
...
int func_38(Player plParam0) // Position - 0x13F9 (5113)
{
	if (plParam0 > -1)
...
BOOL func_39(Player plParam0) // Position - 0x143C (5180)
{
	if (!func_40(plParam0))
		return false;
...
BOOL func_40(Player plParam0) // Position - 0x145B (5211)
{
	Player player;
...
void func_41(var uParam0, int iParam1) // Position - 0x147D (5245)
{
...
BOOL func_42(var uParam0) // Position - 0x1491 (5265)
{
	func_69(PLAYER::PLAYER_PED_ID());
...
BOOL func_43() // Position - 0x154A (5450)
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

BOOL func_44(BOOL bParam0) // Position - 0x155F (5471)
{
	if (bParam0)
...
BOOL func_45(int iParam0) // Position - 0x1588 (5512)
{
	if (iParam0 == 0)
		if (func_66())
			return false;
...
BOOL func_46(Player plParam0) // Position - 0x15F8 (5624)
{
	if (func_49(plParam0))
		return true;
...
BOOL func_47(Player plParam0) // Position - 0x161B (5659)
{
	Player player;
...
BOOL func_48(Player plParam0, int iParam1) // Position - 0x1639 (5689)
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_49(Player plParam0) // Position - 0x1651 (5713)
{
	Player player;
...
BOOL func_51(int iParam0) // Position - 0x1696 (5782)
{
	if (iParam0 == 1)
...
void func_52(var uParam0) // Position - 0x16ED (5869)
{
	if (uParam0->f_11 == 1)
...
void func_53(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1722 (5922)
{
	int i;
	float num;
	float num2;
...
void func_54(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x17D7 (6103)
{
	func_55(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_55(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17FD (6141)
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_56(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1A0D (6669)
{
...
void func_57(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A46 (6726)
{
	if (iParam0 != 198)
	{
		if (Global_79564)
...
void func_58(int iParam0, int iParam1) // Position - 0x1A9E (6814)
{
	switch (iParam0)
	{
		case 12:
...
void func_59(int iParam0, BOOL bParam1) // Position - 0x1B7A (7034)
{
	if (bParam1)
...
BOOL func_60(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1BA3 (7075)
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_61() // Position - 0x2508 (9480)
{
...
int func_62() // Position - 0x2538 (9528)
{
	return Global_33106;
}

int func_63() // Position - 0x2543 (9539)
{
	return Global_33105;
}

int func_64(var uParam0, int iParam1) // Position - 0x254E (9550)
{
	int i;
...
int func_65(int iParam0) // Position - 0x5D8D (23949)
{
	if (iParam0 != 198)
		if (Global_79564)
...
BOOL func_66() // Position - 0x5DC3 (24003)
{
	if (Global_44199 == 15)
		return false;
...
BOOL func_67(int iParam0) // Position - 0x5DD8 (24024)
{
	return Global_44199 == iParam0;
}

float func_68(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5DE6 (24038)
{
...
BOOL func_69(Vehicle veParam0) // Position - 0x5E20 (24096)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_70() // Position - 0x5E3E (24126)
{
	if (func_67(14))
	{
...
void func_71(var uParam0, int iParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12) // Position - 0x5F50 (24400)
{
	uParam0->f_5 = sParam2;
...
Vector3 func_72(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5FB9 (24505)
{
	return func_73(uParam0[0 /*3*/], uParam0[1 /*3*/], 0.5f, true);
}

Vector3 func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x5FD9 (24537)
{
	if (bParam7)
...
float func_74(float fParam0, float fParam1, float fParam2) // Position - 0x6002 (24578)
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_75(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x6029 (24617)
{
	uParam0->[0 /*3*/] = { uParam1 };
	uParam0->[1 /*3*/] = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_76(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x604D (24653)
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_77(int iParam0) // Position - 0x60C2 (24770)
{
	int num;
...
void func_78() // Position - 0x60DA (24794)
{
...
void func_79(var uParam0) // Position - 0x6104 (24836)
{
	*uParam0 = 0;
	return;
}
